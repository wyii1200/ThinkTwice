...
function Nudge() {
  const [state, setState] = useState<"idle" | "saved" | "ignored">("idle");
    ...
    return (
      <MobileFrame hideNav>
        <div className="h-full min-h-[760px] flex flex-col items-center justify-center px-8 text-center">
          ...
          <Link
            to="/dashboard"
            className="mt-auto w-full bg-grad-ai glow-ai text-white font-bold rounded-2xl py-4 text-center"
          >
            Back to dashboard
          </Link>
        </div>
  ...
  if (state === "ignored") {
    return (
      <MobileFrame hideNav>
        <div className="h-full min-h-[760px] flex flex-col justify-center px-8 text-center">
          <div className="w-24 h-24 rounded-full bg-grad-risk mx-auto flex items-center justify-center glow-ai">
            <AlertTriangle className="w-10 h-10 text-white" />
          </div>
          <h1 className="mt-8 text-3xl font-black">Logged and learning</h1>
          <div className="mt-2 text-risk text-2xl font-black">Risk profile updated</div>
          <p className="mt-3 text-sm text-muted-foreground">
            You chose to continue anyway. ThinkTwice recorded the decision, adjusted your resilience
            outlook, and will refine future nudges.
          </p>
          <div className="mt-6 glass-strong rounded-3xl p-4 text-left">
            <div className="text-[11px] uppercase tracking-wider text-muted-foreground">
              Learning loop result
            </div>
            <div className="mt-2 text-sm font-semibold">
              Food overspend pattern reinforced at 10:32 PM near Mid Valley.
            </div>
            <div className="mt-2 text-[11px] text-muted-foreground">
              Next intervention will prioritize Smart Radar and lower-friction food alternatives.
            </div>
          </div>
          <Link
            to="/dashboard"
            className="mt-8 block w-full bg-grad-ai glow-ai text-white font-bold rounded-2xl py-4 text-center"
          >
            Back to dashboard
          </Link>
        </div>
    ...
    <MobileFrame hideNav>
      <div className="px-6 pt-6 pb-8 h-full min-h-[760px] flex flex-col">
        ...
        <h1 className="mt-2 text-3xl font-black leading-tight">
          Think twice before this Starbucks.
        </h1>
        <p className="mt-3 text-sm text-muted-foreground">
          Your food spending today is already{" "}
          <span className="text-risk font-bold">35% above target</span>. This RM12 latte will tip
          you over.
        </p>
        ...
        <div className="mt-5 glass-strong rounded-3xl p-4">
          ...
          <div className="mt-2 h-2 bg-secondary rounded-full overflow-hidden">
            <div className="h-full bg-grad-risk" style={{ width: "100%" }} />
          </div>
        </div>
        ...
        <div className="mt-4 glass rounded-2xl p-3 flex gap-3 items-center">
          ...
          <div className="text-[12px]">
            Mochi suggests: <span className="font-semibold">brew kopi at hostel</span> (saves RM12)
            or <span className="font-semibold">share with a friend</span> (split RM6).
          </div>
        </div>
        ...
        <div className="mt-auto space-y-2.5">
          <button
            ...
            className="w-full bg-grad-emerald glow-emerald text-emerald-foreground font-bold rounded-2xl py-4"
          >
            Save RM10 Automatically
          </button>
          <Link
            to="/radar"
            className="block w-full glass-strong rounded-2xl py-4 font-semibold text-sm text-center"
          >
