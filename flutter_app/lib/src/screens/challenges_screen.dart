...
class _ChallengesPageState extends State<ChallengesPage> {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(child: _sectionToggle(context, 'Challenges', 0)),
              const SizedBox(width: 10),
              Expanded(child: _sectionToggle(context, 'Rewards', 1)),
            ],
          ),
          const SizedBox(height: 16),
          if (_sectionIndex == 0) ...[
  ...
  Widget _sectionToggle(BuildContext context, String label, int index) {
